...
person_df1 <- read.csv("data/tidynomicon/person.csv", header=TRUE, stringsAsFactors = TRUE)
str(person_df1)
...
person_df2 <- read.csv("data/tidynomicon/person.csv", header=TRUE, stringsAsFactors = FALSE)
str(person_df2)
...
voter_turnout_df1 <- read_excel(
    "data/G04ResultsDetail2004-11-02.xls", 
    sheet="Voter Turnout", 
    skip=1
)
